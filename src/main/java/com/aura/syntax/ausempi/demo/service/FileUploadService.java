...
public class FileUploadService {
    ...
    public String deleteFile(String imageUrl) {
        try {
            ...
            if (publicId == null) {
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Invalid video URL");
            }
            ...
            if (!"ok".equals(result.get("result"))) {
                throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Failed to delete video: " + result.get("result"));
            }
